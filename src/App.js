...
class App extends Component {
  ...
  sendSingleTransation(contract_address,address1,recJson,privKey,nonce){
    ...
    address2 = rec;
    var tGasPrice = _this.state.web3GasNum *  1000000000+8000000;     //设置为输入框选择的gas价格
    //交易数据
    const txData = {
                ...
                <div className="pure-u-1-1">
                    ...
                    <div>
                       ...
                       <select onChange={this.web3GasNum} defaultValue={2}>
                            ...
                            <option value={5}>5Gwei</option>
                            <option value={6}>6Gwei</option>
                            <option value={7}>7Gwei</option>
                            <option value={8}>8Gwei</option>
                            <option value={10}>10Gwei</option>
                            <option value={11}>11Gwei</option>
                            <option value={13}>13Gwei</option>
                            <option value={14}>14Gwei</option>
                            <option value={13}>13Gwei</option>
                            <option value={20}>20Gwei</option>
                        </select>
                    </div>
                    <div className="inputBox">
                      <strong>发送方公钥：</strong>
